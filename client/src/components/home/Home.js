...
;
  ...
  <p className="lead text-dark">
    Explore the world of chess and sharpen your strategies with interactive lessons.  
    Learn from experts, practice tactics, and elevate your game—one move at a time!
  </p>
        </div>
