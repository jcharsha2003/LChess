...
const Studentd = (props) => {
      ...
      </button>
 {
  ...
  >
    <MenuItem onClick={handleClose}>Therory Sessions</MenuItem>
    <Divider />
    <MenuItem onClick={handleClose}>Practice Sessions</MenuItem>
  </Menu>):(<Menu
    anchorEl={anchorEl}
    id="account-menu"
    open={open}
  ...
  >
    <MenuItem onClick={handleClose}>Therory Sessions</MenuItem>
    <Divider />
    <MenuItem onClick={handleClose}>Practice Sessios</MenuItem>
  </Menu>)
 }
